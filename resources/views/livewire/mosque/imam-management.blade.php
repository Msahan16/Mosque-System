                            ...
                            @forelse($imams as $imam)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center space-x-2">
                                        <button wire:click="openImamModal({{ $imam->id }})" class="inline-flex items-center px-3 py-1 bg-blue-600 text-white text-xs font-medium rounded hover:bg-blue-700 transition">
                                            Edit
                                        </button>
                                        <button onclick="confirmDelete('confirmDeleteImam', {{ $imam->id }}, 'Delete Imam?', 'This will permanently delete this imam and all related records. This action cannot be undone.')" class="inline-flex items-center px-3 py-1 bg-red-600 text-white text-xs font-medium rounded hover:bg-red-700 transition">
                                            Delete
                                        </button>
                                    </td>
                                </tr>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center space-x-2">
                                        @if($advance->status !== 'paid')
                                            <button wire:click="payAdvance({{ $advance->id }})" class="inline-flex items-center px-3 py-1 bg-green-600 text-white text-xs font-medium rounded hover:bg-green-700 transition">
                                                Pay
                                            </button>
                                        @endif
                                        <button wire:click="openAdvanceModal({{ $advance->id }})" class="inline-flex items-center px-3 py-1 bg-purple-600 text-white text-xs font-medium rounded hover:bg-purple-700 transition">
                                            Edit
                                        </button>
                                        <button onclick="confirmDelete('confirmDeleteRecord', {{ $advance->id }}, 'Delete Advance Record?', 'This will permanently delete this advance record. This action cannot be undone.')" class="inline-flex items-center px-3 py-1 bg-red-600 text-white text-xs font-medium rounded hover:bg-red-700 transition">
                                            Delete
                                        </button>
                                    </td>
                                </tr>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse($availableDays as $day)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center space-x-2">
                                        <button wire:click="openDaysModal({{ $day->id }})" class="inline-flex items-center px-3 py-1 bg-orange-600 text-white text-xs font-medium rounded hover:bg-orange-700 transition">
                                            Edit
                                        </button>
                                        <button onclick="confirmDelete('confirmDeleteDay', {{ $day->id }}, 'Delete Availability?', 'This will permanently delete this availability record. This action cannot be undone.')" class="inline-flex items-center px-3 py-1 bg-red-600 text-white text-xs font-medium rounded hover:bg-red-700 transition">
                                            Delete
                                        </button>
                                    </td>
                                </tr>
